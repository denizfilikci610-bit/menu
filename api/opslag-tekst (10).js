...
const LAYOUTS  = ['hero-bl','hero-center','hero-top','hero-tr','spotlight','band-top','band-bottom','band-mid','split-left','split-right','split-h-top','split-h-bottom','sidebar-r','card-bottom','card-center','corner','postcard','framed','poster','type','quote','ticket','minimal','duo-v','duo-h','grid-4','collage-3','mosaic','filmstrip','triptych'];
...
export default async function handler(req, res) {
  ...
  lines.push(
    ...
    '  Ét foto: hero-bl/hero-center/hero-top/hero-tr/spotlight (tekst på foto), band-top/band-bottom/band-mid (farvefelt+foto), split-left/split-right/split-h-top/split-h-bottom (halvt foto), sidebar-r/card-bottom/card-center/corner (tekst i felt på foto), postcard, framed.',
    '  Uden foto: poster, type, quote, ticket (kupon), minimal.',
    '  FLERE fotos: duo-v/duo-h (2 fotos), collage-3/mosaic/filmstrip/triptych (3 fotos), grid-4 (4 fotos). Vælg KUN disse hvis emnet passer til flere billeder (fx menu, galleri, før/efter, kollektion, events).',
